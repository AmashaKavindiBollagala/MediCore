...
async function fixSchema() {
  ...
  try {
    ...
    // patient_id = UUID (from auth-service)
    // doctor_id = INTEGER (from doctor-service)
    await client.query(`
    ...
    console.log('   - patient_id: UUID (from auth-service)');
    console.log('   - doctor_id: INTEGER (from doctor-service)');
