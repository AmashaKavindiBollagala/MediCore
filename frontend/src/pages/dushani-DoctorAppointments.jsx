...
const NAV_ITEMS = [
  ...
  {
    id: 'availability', label: 'Availability', route: '/doctor-dashboard',
  ...
  {
    id: 'reports', label: 'Patient Reports', route: '/doctor-dashboard',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" stroke="currentColor" strokeWidth="1.8"/></svg>,
  },
  {
  ...
  const handleAppointmentAction = async (appointmentId, action) => {
    try {
      ...
      await fetch(`/api/appointments/${appointmentId}/${endpoint}`, {
        ...
        body: JSON.stringify({ status: action === 'complete' ? 'COMPLETED' : undefined }),
      });
      fetchAppointments();
    } catch (err) {
